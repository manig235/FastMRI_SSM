...
def train(args):
    ...
    val_loader = create_data_loaders(data_path = args.data_path_val, args = args, train_size = args.val_size)    
    for epoch in range(start_epoch, args.num_epochs):
        print(f'Epoch #{epoch:2d} ............... {args.net_name} ...............')
        train_loader = create_data_loaders(data_path = args.data_path_train, args = args, shuffle=True, train_size = args.train_size)
